...
const ServiceModalFa = ({ isOpen, onClose, service }) => {
  ...
  const handleSubmit = (event) => {
   ...
   const addToFavouriteHandler =()=>{
    cartCtx.removeItemFavourite(service.id)
    onClose()
   }
    ...
    >
      ...
      <div className="rounded-t-lg shadow-lg w-full flex flex-col text-center  ">
        ...
        <div className="rounded-t-[40px] w-[100%] bg-white dark:bg-gray-800 p-6 z-[100] mt-[-40px] pb-[42px]">
          ...
          <button onClick={addToFavouriteHandler} className="bg-black p-3 rounded-[10px] text-white ">remove</button>
